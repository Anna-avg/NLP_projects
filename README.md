...
1. Проект по кластеризации содержит видео работы дообученной модели, встроенной в интерфейс, презентацию сравнение результатов модели до/после обучения, ipnb файл с алгоритмом обучения и предобработкой текстов.
